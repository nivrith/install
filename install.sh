...
if [ ! -d "/Applications/GitKraken.app" ]; then
  ...
  info "GitKraken is already installed."
fi
...
if [ ! -d "/Applications/Notion.app" ]; then
  ...
  info "Notion is already installed."
fi
...
if [ ! -d "/Applications/ChatGPT.app" ]; then
  ...
  info "ChatGPT is already installed."
fi
...
if [ ! -d "/Applications/Superwhisper.app" ]; then
  ...
  info "Superwhisper is already installed."
fi
...
if [ ! -d "/Applications/TablePlus.app" ]; then
  ...
  info "TablePlus is already installed."
fi
...
if [ ! -d "/Applications/Warp.app" ]; then
  ...
  info "Warp Terminal is already installed."
fi

# Install JetBrains Toolbox
if [ ! -d "/Applications/JetBrains Toolbox.app" ]; then
  echo "Installing JetBrains Toolbox..."
  brew install --cask jetbrains-toolbox || handle_error "Failed to install JetBrains Toolbox"
else
...
if [ ! -d "/Applications/CleanShot X.app" ]; then
  ...
  info "CleanShot is already installed."
fi
...
if ! command_exists mas; then
  ...
  info "mas-cli is already installed."
fi

# Install Font Fira Code
if [ ! -d "$HOME/Library/Fonts/FiraCode-Retina.ttf" ]; then
  echo "Installing Fira Code..."
  brew install --cask font-fira-code || handle_error "Failed to install Fira Code"
else
  info "Fira Code is already installed."
fi
...
if mas list &>/dev/null; then
  ...
  if ! mas list | grep -q "$PERPLEXITY_ID"; then
    ...
    info "Perplexity is already installed."
  fi
  ...
  if ! mas list | grep -q "$CANVA_ID"; then
    ...
    info "Canva is already installed."
  fi
  ...
  if ! mas list | grep -q "$GIFSKI_ID"; then
    ...
    info "Gifski is already installed."
  fi
